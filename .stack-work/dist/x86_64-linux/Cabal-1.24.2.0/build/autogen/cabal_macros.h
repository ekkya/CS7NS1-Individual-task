...
/* package echo-service-0.1.0.0 */
#define VERSION_echo_service "0.1.0.0"
#define MIN_VERSION_echo_service(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "echo-service-0.1.0.0-Cb4cOm8PIQx5UTeEunrLTD"

#define CURRENT_PACKAGE_KEY "echo-service-0.1.0.0-Cb4cOm8PIQx5UTeEunrLTD"
